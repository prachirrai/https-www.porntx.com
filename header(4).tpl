...
<div class="modal fade" id="tpl-modal"><div class="modal-dialog tpl-modal"><div class="modal-content"><div class="modal-header">
<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
<h4 class="modal-title">Layout Type</h4></div>
<div class="modal-body">
<form method="post" action=""><input type="hidden" name="tpl-submit" value="bright-model"/><input type="submit" class="btn btn-primary" value="Bright" /></form>
<form method="post" action=""><input type="hidden" name="tpl-submit" value="dark-model"/><input type="submit" class="btn btn-default m-t-5" value="Dark" /></form>
</div></div></div></div>